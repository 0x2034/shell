...
objFile.WriteLine "        echo        print^(f'Connection established to {target_ip}:{target_port}'^)"
objFile.WriteLine "        echo    except ConnectionRefusedError as e:"
objFile.WriteLine "        echo        print^(f'Connection to {target_ip}:{target_port} refused. Check if listener is running.'^)"
